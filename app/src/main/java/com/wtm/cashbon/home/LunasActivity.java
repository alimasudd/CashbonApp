...
public class LunasActivity extends AppCompatActivity {
    ...
    private ActivityLunasBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityLunasBinding.inflate(getLayoutInflater());
    ...
    private void getKasbonStatus() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppConf.URL_GET_CASHBON_STATUS, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (SessionHelper.sessionManager(LunasActivity.this).checkResponse(response)) {
                    ...
                    try {
                        ...
                        LinearLayoutManager llm = new LinearLayoutManager(LunasActivity.this);
        ...
        VolleyHttp.getInstance(LunasActivity.this).addToRequestQueue(stringRequest);
    }
