...
import com.wtm.cashbon.databinding.ActivityAktifBinding;
import com.wtm.cashbon.databinding.ActivityLunasBinding;
...
public class AktifActivity extends AppCompatActivity {
    ...
    private ActivityAktifBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityAktifBinding.inflate(getLayoutInflater());
    ...
    private void getKasbonStatus() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppConf.URL_GET_CASHBON_STATUS, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (SessionHelper.sessionManager(AktifActivity.this).checkResponse(response)) {
                    ...
                    try {
                        ...
                        LinearLayoutManager llm = new LinearLayoutManager(AktifActivity.this);
        ...
        VolleyHttp.getInstance(AktifActivity.this).addToRequestQueue(stringRequest);
    }
